This project is an improvised version of the original Project Tracking Website made by dotnetcurry (https://github.com/dotnetcurry/angular-webapi-series). <br/>
